...
public class HandlingConfigFile {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		// Using Wrapper class to convert String into Long
		String a = prop.getProperty("pageLoadTimeDuration");
		long pageLoadTimeDuration = Long.valueOf(a);
		
		driver.manage().timeouts().pageLoadTimeout(pageLoadTimeDuration, TimeUnit.SECONDS); 
